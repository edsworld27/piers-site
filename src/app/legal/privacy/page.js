export const metadata = {
  title: "Privacy Policy | Elevate Hypnotherapy UK",
    ...
    <main className="pt-32 pb-24 text-standard">
      <div className="container" style={{maxWidth: "800px"}}>
        ...
        <div className="glass-panel p-8 content">
          ...
          <p>Elevate Hypnotherapy ("we", "our", or "us") is committed to protecting your privacy in compliance with the UK General Data Protection Regulation (UK GDPR) and the Data Protection Act 2018. This policy explains how we collect, use, and protect your personal data.</p>
          ...
          <h2>5. Your Rights</h2>
          <p>Under UK GDPR, you have the right to request access to, correction of, or deletion of your personal data. To exercise these rights, please contact us at <code>hello@elevatehypnotherapy.co.uk</code>.</p>
        </div>
      </div>
      <style>{`
        ...
        .content code { background: rgba(255,255,255,0.1); padding: 0.2rem 0.4rem; border-radius: 4px; color: white; }
      `}</style>
    </main>
  );
}
